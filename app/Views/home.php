...
<div class="container">
    ...
    <section>
        ...
        <blockquote>
            ...
            <p>I want 2 pages:
                <br>1) login:
                <br>2) pages that show 2 fields 1 select box with subject (any subject that you want for ex. sport,
                politics, developing and etc.) and second to implement text editor with fonts size images (you can use
                any library that you want), under that you will see the posts and be able to delete them.
            </p>

            <p>In the login section there will be 3 types of users , a regular user that can see and delete only his own
                messages.</p>

            <p>Admin that is related to the subject in the select box, they will see any message with the subject that
                they manage, and manager that can see and delete all messages.
